...
from svp.vcifar.models import MODELS
from svp.vcifar.datasets import DATASETS
from svp.vcifar.train import train as train_function
from svp.vcifar.active import active as active_function
from svp.vcifar.coreset import coreset as coreset_function
...
@click.option('--train2test', type=bool, default=False, show_default=False,
              help=('Binary varialbe that use trainset as validataion'))
...
def active(run_dir: str,
           ...
           datasets_dir: str, dataset: str, augmentation: bool,
           validation: int, shuffle: bool, initial_balance : bool,
           subset_bias: int, 
