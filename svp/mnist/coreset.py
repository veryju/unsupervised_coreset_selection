...
from svp.mnist.datasets import create_dataset
from svp.mnist.train import create_model_and_optimizer
...
def coreset(run_dir: str = './run',
            ...
            datasets_dir: str = './data', dataset: str = 'mnist',
            augmentation: bool = True, dataset_size: int=0,
    ...
    if train_target:
        ...
        target_stats['runs'] = runs
        target_stats['dataset'] = dataset
        target_stats['selection_method'] = selection_method
