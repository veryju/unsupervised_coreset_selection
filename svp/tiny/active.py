...
from svp.tiny.datasets import create_dataset
from svp.tiny.train import create_model_and_optimizer
...
def active(run_dir: str = './run',
           ...
           datasets_dir: str = './data', dataset: str = 'tiny',
    ...
    if precomputed_selection is not None:
        ...
        if coreset_path is not None:
            ...
            if isCoreLoss:
                ...
                #sim_mean = sim_loss.mean()
                #sim_std = sim_loss.std()
                #sim_loss = sim_loss-sim_mean
                #sim_loss = sim_loss/sim_std
