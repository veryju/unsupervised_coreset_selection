...
from svp.tiny.models import MODELS
from svp.tiny.datasets import DATASETS
from svp.tiny.train import train as train_function
from svp.tiny.active import active as active_function
from svp.tiny.coreset import coreset as coreset_function
...
def dataset_options(func):
    ...
    decorators = [
        ...
        click.option('--dataset', '-d', type=click.Choice(DATASETS),
                     default='tiny', show_default=True,
...
def active(run_dir: str,
           ...
           augmentation: bool, validation: int, shuffle: bool, 
           initial_balance : bool, subset_bias: int,
